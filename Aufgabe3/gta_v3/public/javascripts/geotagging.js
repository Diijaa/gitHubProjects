...
function setLocation(l)
{
    ...
    var geotags = JSON.parse(DOMHelper.map.dataset.geotags);
    var mm = new MapManager("DXHmKi9wWUmRzAOMw5MAGcnGs9zLpq6K");
    var mapUrl = mm.getMapUrl(l.latitude, l.longitude, geotags, 13); 

    DOMHelper.map.src = mapUrl;
}
